...
/**
 * Lifecycle callbacks for the `Debtorrating` model.
 */

/**
 * Checks whether at least one day has passed between now and `datetimeString`
 */
function hasOneDayPassed(datetimeString) {
  return new Date() - new Date() % (1000 * 60 * 60 * 24) > +new Date(datetimeString)
}
